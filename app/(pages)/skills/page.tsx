...
export default function Skills() {
  return (
    <section className='bg-background text-foreground min-h-screen mt-8 mb-12'>
      <HeadingTwo text='Skills' type='primary' className='mb-4' />

      <div className='mt-2 grid grid-cols-1 md:grid-cols-2 gap-6'>
        {/* Data Analysis Tools */}
        <div className='border border-customPink bg-card p-6 rounded-lg hover:shadow-lg transition-shadow'>
